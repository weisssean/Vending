 ...
 */
public class ChangeAdapter extends ArrayAdapter<Coin> {
    ...
    public ChangeAdapter(Context context, int resource, List<Coin> coins) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null)  {
            ...
            txt2.setText("Quantity: "+item.quantity);
            return v;
